    ...
    <PageTransition>
      <ContentProtection enableScreenshotProtection>
        <div className="min-h-screen bg-gradient-to-b from-black via-orange-950 to-black text-white relative overflow-hidden">
          ...
          <div className="relative z-10 border-b border-orange-500/30 bg-gradient-to-r from-orange-900/50 to-black/80">
            <div className="max-w-4xl mx-auto px-4 py-6">
              ...
              <div className="flex items-center space-x-6 mt-4">
                ...
                <div className="flex-1">
                  ...
                  <h2 className="text-xl text-orange-300 mb-3" style={{ fontFamily: 'Cinzel' }}>
                    Flammae Infernales
                  </h2>
