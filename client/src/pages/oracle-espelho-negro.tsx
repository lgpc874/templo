      ...
      <ContentProtection enableScreenshotProtection>
        <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-20 left-20 w-96 h-96 bg-purple-900/10 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute bottom-20 right-20 w-80 h-80 bg-indigo-900/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
            <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-violet-900/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }}></div>
          </div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 py-12">
            <Card className="bg-gradient-to-br from-gray-900/80 to-black/80 border-purple-500/30 backdrop-blur-sm">
              <CardHeader className="text-center pb-8">
                <div className="w-24 h-24 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-6 relative">
                ...
                <CardDescription className="text-gray-300 text-lg max-w-2xl mx-auto" style={{ fontFamily: 'EB Garamond' }}>
                  Para que o Espelho Negro possa refletir sua verdadeira essência, 
                  precisamos conhecer seu nome verdadeiro e o momento de sua chegada a este plano.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-8">
                <div className="grid gap-6 max-w-md mx-auto">
                  <div className="space-y-2">
                    <Label htmlFor="userName" className="text-purple-300 font-medium" style={{ fontFamily: 'Cinzel' }}>
                      Seu Nome Verdadeiro
                    </Label>
                    <Input
                      id="userName"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="birthDate" className="text-purple-300 font-medium" style={{ fontFamily: 'Cinzel' }}>
                      Data de Nascimento
                    </Label>
                    <Input
                      id="birthDate"
                ...
                <div className="text-center pt-6">
                  <Button
                    ...
                    className="px-12 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold text-lg rounded-lg transition-all duration-300 disabled:opacity-50"
                ...
                <div className="text-center text-sm text-gray-400 pt-4" style={{ fontFamily: 'EB Garamond' }}>
                  <p>As verdades reveladas pelo Espelho Negro são destinadas apenas a você.</p>
                  <p>Mantenha sigilo sobre os segredos desvelados.</p>
                </div>
              </CardContent>
            </Card>
          </div>
